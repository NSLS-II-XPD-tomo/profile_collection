...
class XPDAlliedVision(XPDDetector):
    ...
    pixel_size = Component(Signal, value=0.00250, kind="config")
    detector_type = Component(Signal, value="AlliedVision 1800 U-811m", kind="config")
...
class AlliedVisionContinuous(ContinuousAcquisitionTrigger, XPDAlliedVision):
...
try:
    ...
    alliedvision_c = AlliedVisionContinuous(
